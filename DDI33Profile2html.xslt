...
-->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:pr="ddi:ddiprofile:3_3" xmlns:r="ddi:reusable:3_3" xmlns="http://www.w3.org/1999/xhtml" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:my="my:namespace-file-mapping" exclude-result-prefixes="my pr r xhtml">
	<!-- - - - - - - - - - - -->
	...
	<!-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -->
	<xsl:variable name="URLPrefix" select=" 'http://www.ddialliance.org/Specification/DDI-Lifecycle/3.3/XMLSchema/FieldLevelDocumentation/schemas/' "/>
	<xsl:variable name="URLIntermediatePiece" select=" '/elements/' "/>
	<xsl:variable name="URLPostfix" select=" '.html' "/>
	<xsl:variable name="NamespaceFileMappingURL" select=" 'DDI33NamespaceFileMapping.xml' "/>
	<xsl:variable name="NamespaceFileMappingNode" select="document( $NamespaceFileMappingURL )"/>
	<!-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -->
	<my:NamespaceFileMapping>
		<my:Map key="ddi:archive:3_3" value="archive_xsd"/>
		<my:Map key="ddi:comparative:3_3" value="comparative_xsd"/>
		<my:Map key="ddi:conceptualcomponent:3_3" value="conceptualcomponent_xsd"/>
		<my:Map key="ddi:datacollection:3_3" value="datacollection_xsd"/>
		<my:Map key="ddi:dataset:3_3" value="dataset_xsd"/>
		<my:Map key="http://purl.org/dc/terms/" value="dcterms_xsd"/>
		<my:Map key="ddi:ddiprofile:3_3" value="ddiprofile_xsd"/>
		<my:Map key="ddi:group:3_3" value="group_xsd"/>
		<my:Map key="ddi:instance:3_3" value="instance_xsd"/>
		<my:Map key="ddi:logicalproduct:3_3" value="logicalproduct_xsd"/>
		<my:Map key="ddi:physicaldataproduct:3_3" value="physicaldataproduct_xsd"/>
		<my:Map key="ddi:physicaldataproduct_ncube_inline:3_3" value="physicaldataproduct_ncube_inline_xsd"/>
		<my:Map key="ddi:physicaldataproduct_ncube_normal:3_3" value="physicaldataproduct_ncube_normal_xsd"/>
		<my:Map key="ddi:physicaldataproduct_ncube_tabular:3_3" value="physicaldataproduct_ncube_tabular_xsd"/>
		<my:Map key="ddi:physicaldataproduct_proprietary:3_3" value="physicaldataproduct_proprietary_xsd"/>
		<my:Map key="ddi:physicalinstance:3_3" value="physicalinstance_xsd"/>
		<my:Map key="ddi:reusable:3_3" value="reusable_xsd"/>
		<my:Map key="ddi:studyunit:3_3" value="studyunit_xsd"/>
	</my:NamespaceFileMapping>
	<!-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -->
